---
title: "Introducing BWH Studios"
description: "Leaving Frappe, but not leaving Frappe."
...
My professional career started as a part time TA for this [Python programming masterclass](https://www.udemy.com/course/python-the-complete-python-developer-course/) on Udemy. My job was to answer questions/doubts in the QnA section of the course. It paid hourly and was a nice side gig alongside my college! The bonus effect of this was that I ended up getting pretty good at writing Python in a year or so 😁
...
The DM was from [Ankush Menat](https://www.linkedin.com/in/ankushmenat/). Ankush was my college mate and he had recently joined Frappe. He suggested me to apply and see if I could get in as an Engineer intern. In the February of 2021, I started my journey as an intern at Frappe. My plan was to learn "real-world" app development, gain some experience, and be on my way. But obviously that is not how it turned out to be 😁

Right after my onboarding, I got to work in the ERPNext team with Rucha and [here is my first PR](https://github.com/frappe/erpnext/pull/25209) on the app. During this time, I noticed Frappe Cloud team doing cool stuff and was very curious on how it all worked. Within a few weeks, I shifted to FC team and worked with them for about 1.5 years. I have shared my experience working on FC [in this detailed blog](https://frappe.io/blog/meet-the-team/the-team-frappe-cloud-experience). Also, I got the chance to give [my first conference talk](https://youtu.be/mvkDwTEN6Jk?feature=shared) ever.
...
What was supposed to be a "just one live stream" experiment turned out to be [a weekly series](https://youtube.com/playlist?list=PLQGFK8RiEPSK2DbKF5X0jm8dUCOP2TbuH&feature=shared) with thousands of subscribers! I had found my sweet spot and *things started to fall in place*: international bootcamps, new courses on Frappe School, live product releases, collaboration with the broader FOSS community, and much more! Exciting times.
...
1. **Consultancy**: We will guide you to build world-class Frappe based apps and platforms. Let me help you **make the most out of the Frappeverse**.
2. **Development**: Get best-in-class Frappe custom apps (or integrations) built by our team of developers, including me. Frappe themselves are also a client of ours, btw 😉
3. **Training**: We are an official Frappe School partner. We will help you train your team of devs. We even have a **Frappe Framework: Zero to Hero Bootcamp** that I am going to soon write a blog on!
4. **Content**: We produce video content (or course) for your open source products.
...
Thank you everyone who has supported BWH till now. Looking forward to your continued support in this new journey. Don't forget to follow me and our [shiny new LinkedIn page](https://www.linkedin.com/company/bwh-studios/) to be part of it!

#### Want to work with us?

Now onto some sales 🤣: <strike>fill in this form if you think we can help you get things done!</strike> We are currently full and temporarily not accepting any new projects.
